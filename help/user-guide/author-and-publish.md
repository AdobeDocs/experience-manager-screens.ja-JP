...
>[!NOTE]
>
>この AEM Screens 機能は、AEM 6.4 Screens 機能パック 2 がインストールされている場合にのみ使用できます。この機能パックへのアクセス権を取得するには、Adobeサポートに連絡してアクセス権をリクエストします。 アクセス権が付与されると、Package Share から機能パックをダウンロードできます。
...
1. 「」をクリックします **複製** 左側のナビゲーションツリーから。

   ![screen_shot_2019-02-25at24715pm](assets/screen_shot_2019-02-25at24715pm.png)

1. 「」をクリックします **オーサー環境のエージェント** から **複製** フォルダーをクリックし、 **新規** 新しい標準レプリケーションエージェントを作成するには、次の手順に従います。

   ![screen_shot_2019-02-25at25400pm](assets/screen_shot_2019-02-25at25400pm.png)

1. を入力 **タイトル** および **名前** レプリケーションエージェントを作成したら、 **作成**.
...
1. **エージェント設定**&#x200B;ダイアログボックスで、詳細を入力します。
   ...
   >[!NOTE]
   >
   >ユーザーは確認する必要があります **Enabled** をクリックしてレプリケーションエージェントを有効にします。 デフォルト、Screens、リバースレプリケーションエージェントでこのオプションをオンにします。
...
1. pub2 の AEM Screens レプリケーションエージェントを作成します。pub1 の Screens レプリケーションエージェントをコピーし、pub2 の 4504 を指すようにポートを変更します。
   ...
   >[!NOTE]
   >Screens レプリケーションエージェントの設定方法については、次を参照してください。 [Screens レプリケーションエージェントの設定](https://experienceleague.adobe.com/ja/docs/experience-manager-screens/user-guide/administering/configure-screens-replication).
...
1. クリック **Apache Sling Oak-Based Discovery Service** 設定。
...
1. 「**Protect**」をクリックします。
1. 値をコピー **保護されたテキスト** メモ帳またはテキストエディター この値を、ActiveMQ の OSGi 設定で使用できます。
...
1. クリック **Apache ActiveMQ Artemis JMS Provider** 設定
1. 以下を更新します。

   * ***クラスターパスワード***：各インスタンスで前の手順で暗号化された値を使用します
...
1. クリック **Apache Sling Referrer Filter**
...
1. デバイスをクリックし、 **Activate** アクションバーから移動します（下図を参照）。

![screen_shot_2019-02-21at111036am](assets/screen_shot_2019-02-21at111036am.png)

>[!NOTE]
>
>または、デバイスをアクティベートした後で、サーバー URL を編集または更新することもできます。アクションバーで、 **サーバー URL を編集**&#x200B;を参照してください（下図を参照）。 変更内容がAEM Screens Player に反映されます。
...
* *Screens デバイスユーザー*  – この情報は、AEM ユーザーとして保存され、からアクティブ化できます。 **ツール** > **セキュリティ** > **ユーザー**. ユーザー名の先頭には、「screens」とシリアル化された長い文字列が付けられます。

* *プロジェクト* - AEM Screens プロジェクト。
* *場所* - デバイスが接続されている場所。
* *チャネル*  – その場所に表示されている 1 つ以上のチャネル。
* *スケジュール* - スケジュールを使用する場合は、このスケジュールが公開されていることを確認します。
* *場所、スケジュール、チャネルフォルダー*  – 対応するリソースがフォルダー内にある場合。
...
1. を選択 **URL を編集** オーサーインスタンスの URL から、パブリッシュインスタンスの URL のいずれかに移動します。
...
1. Screens Player で管理 UI を表示します。左上隅を長押しして、管理メニューを開いたり、タッチ操作対応AEM Screens Player で開いたり、マウスを使用したりします。
...
1. アクションバーの「**デバイスマネージャー**」をクリックします。
1. デバイスをクリックし、アクションバーでをクリックします。 **サーバー URL を編集**&#x200B;を参照してください（下図を参照）。 変更内容がAEM Screens Player に反映されます。
...
以下の節に従って、作成者と公開の設定に関連したよくある質問に対する回答を入手します。
