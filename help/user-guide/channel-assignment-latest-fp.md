...
1. 「**設定**」オプションから、**パス**&#x200B;または&#x200B;**名前**&#x200B;でチャネルを選択し、**チャネルロール**、**優先度**、**サポートされているイベント**、**中断方法**&#x200B;を入力できます。 また、このダイアログボックスでアトラクションツールチップを有効にすることもできます。
   ...
   >[!NOTE]
   >
   >チャネル割り当てプロパティについて詳しくは、[チャネルプロパティ](#channel-properties)の節を参照してください。
...
チャネルロールはディスプレイのコンテキストを定義します。 様々なアクションで、役割を対象とします。 役割を果たす実際のチャネルとは無関係です。

### 優先度 {#priority-channel}

優先度は、複数の割り当てが再生条件に一致する場合に、割り当ての順序付けを行うために使用します。 最も高い値のものが低い値よりも常に優先されます。 例えば、A と B の 2 つのチャネルがあるとします。 A の優先度は 1、B の優先度は 2 であり、A よりも優先度が高いのでチャネル B が表示されます。
...
**チャネル割り当て**&#x200B;ダイアログボックスで、中断方法を設定できる次のオプションのいずれかを選択します。
...
| **名前** | **繰り返し** | **開始** | **終了** |
|---|---|---|---|
| 朝食 | 毎日 | 【午前】 6 時 :00 分 | 【午前】 11:00。 |
| ランチ | 毎日 | 【午前】 11:00。 | 【午後】 3:00。 |
| ディナー | 毎日 | 【午後】 3:00。 | 【午後】 8:00。 |

#### コンテンツを週の特定の日に再生 {#playing-content-on-a-particular-day-of-the-week}

この例は、毎週末の午後 8 時から午後 10:00 までライブイベントが発生するカジノに実装された日分割を示しています。また、午後 10:00 以降は午前 1:00 までディナーメニューにスペシャルを利用でき :00 す。

| **名前** | **繰り返し** | **開始** | **終了** |
|---|---|---|---|
| 週末 | 毎週：土曜日と日曜日 | 【午後】 8:00。 | 【午後 :0010 時 |
| スペシャル | 毎日：月曜日から金曜日 | 【午後 :0010 時 | 【午前】 1 時 :00 分 |
