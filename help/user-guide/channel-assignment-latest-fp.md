...
ここでは、毎日3つの異なる時間スロットに分割し、チャネルのコンテンツが指定した時間ごとに再生されるようにします。 では、次の繰り返しスケジュールのプロパティを設定して、この使用例に従ってコンテンツを再生します。

| **名前** | **繰り返し** | **Start** | **End** |
|---|---|---|---|
| モーニング | 毎日 | 6:00 AM | 11:00 AM |
| モーニング | 毎日 | 11:02 AM | 3:00 PM |
| モーニング | 毎日 | 3:01 PM | 8:00 PM |

#### コンテンツを特定の曜日に再生 {#playing-content-on-a-particular-day-of-the-week}

次の例は、カジノのDayPartingの実績を示しています。このカジノでは、毎週週末に8:00から午後10:00までライブイベントが発生し、午後10:00から午前1:00までの間は特別な料理をディナーメニューに使用できます。
