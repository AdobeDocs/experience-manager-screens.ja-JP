...
割り込み方法を設定するには、[割り当て]ダイアログボックスで次のオプ **ション** チャネルを使用します。

* **今すぐ**:スケジュールがアクティブになったり、更新を受け取った場合は、再生を切り離し、新しいコンテンツをすぐに更新または再生します
* **現在のアイテムの最後**:新しいスケジュールがアクティブになったり、更新を受け取った場合、シーケンス内の現在のアイテムの再生が終了するのを待ち、その後で新しいコンテンツを更新または再生します
   >[!NOTE]
   >これは、選択されたデフォルトのオプションです。
* **シーケンスの最後**:新しいスケジュールがアクティブになったり、更新を受け取った場合、シーケンス全体が終了するのを待ち、最初の要素に戻る直前に、新しいコンテンツを更新または再生します
