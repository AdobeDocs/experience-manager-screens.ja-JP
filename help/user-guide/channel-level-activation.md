...
>[!NOTE]曜日や月を定義する場合は、省略形または通常の表記を使用できます（月／月曜日、1／1 月など）。
...
>[!NOTE]曜日や月を定義する場合は、省略形または通常の表記を使用できます（月／月曜日、1／1 月など）。さらに、_午前／午後_&#x200B;表記（例：午後 2:00）ではなく、*24 時間*&#x200B;表記（例：14:00）を使用することもできます。
