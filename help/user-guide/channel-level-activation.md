...
1. **ディスプレイにチャネルを割り当てる**
   ...
   **MainAdChannel** の場合は次の手順に従います。
   ...
   1. に移動します。 **チャネルレベルの有効化** > **場所** > **地域** > **RegionDisplay** を選択して、 **チャネルを割り当て** アクションバーから。
   1. **チャネル割り当て**&#x200B;ダイアログボックスが開きます。
   1. を選択 **参照チャネル** パス。
   1. 「」を選択します **チャネルパス** as **チャネルレベルの有効化** > ***チャネル*** > ***MainAdChannel***.
   ...
   >[!NOTE]
   >
   >また、に移動して、表示ダッシュボードからチャネルを割り当てることもできます **チャネルレベルの有効化** > **場所** > **地域** > **RegionDisplay** および選択 **Dashboard** アクションバーから。 を選択 **+ チャネルを割り当て** から **割り当てられたチャネルとスケジュール** パネル。
   ...
   1. **チャネル割り当て**&#x200B;ダイアログボックスが開きます。
   1. を選択 **参照チャネル** パス。
   1. 「」を選択します **チャネルパス** as **チャネルレベルの有効化*** > ***チャネル*** > ***TargetedSinglePlay***.
   1. 「**チャネルロール**」は **targetedsingleplay** に設定します。
   1. 「**優先度**」を「**2**」に設定します。
   1. 「」を選択します **サポートされるイベント** as **初期読み込み**, **アイドル画面**、および **タイマー**&#x200B;を参照してください（下図を参照）。
   ...
   >[!NOTE]
   >
   >同じ日を選択するには、次の日を選択し、後で日付を同じ日に手動で編集します。 これにより、ユーザーが過去の日付を選択できなくなります。 次の例を参照してください。
...
1. チャネルを選択してから、 **Dashboard** アクションバーから。
