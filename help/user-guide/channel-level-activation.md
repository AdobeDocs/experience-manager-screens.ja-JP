...
1. **ディスプレイにチャネルを割り当てる**
   ...
   **MainAdChannel** の場合は次の手順に従います。
   ...
   1. 選択 **チャネルを参照**... パス別。
   1. を選択します。 **チャネルパス** as **チャネルレベルのアクティベーション** > ***チャネル*** > ***MainAdChannel***.
   ...
   >[!NOTE]
   >
   >ディスプレイダッシュボードからチャネルを割り当てるには、次の場所に移動します。 **チャネルレベルのアクティベーション** > **場所** > **地域** > **RegionDisplay** をクリックし、 **ダッシュボード** をクリックします。 **割り当てられたチャネルとスケジュール**&#x200B;パネルで「**+ チャネルを割り当て**」をクリックします。
   ...
   1. **チャネル割り当て**&#x200B;ダイアログボックスが開きます。
   1. 選択 **チャネルを参照**... パス別。
   1. を選択します。 **チャネルパス** as **チャネルレベルのアクティベーション*** > ***チャネル*** > ***TargetedSinglePlay***.
   1. 「**チャネルロール**」は **targetedsingleplay** に設定します。
   1. 「**優先度**」を「**2**」に設定します。
   1. 「**サポートされているイベント**」として「**最初の読み込み**」、「**待機中画面**」、「**タイマー**」を選択します（以下の図を参照）。
   1. 日付を **次の日から有効：** を 2018 年 11 月 27 日午後 11 時 59 分、 **次の日まで有効** 2018 年 11 月 28 日午前 12 時 5 分として
   1. 「**保存**」をクリックします。
