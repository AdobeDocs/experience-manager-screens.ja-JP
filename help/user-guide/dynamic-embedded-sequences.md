...
>
>***動的埋め込みシーケンス***&#x200B;ではロケーション固有のコンテンツを表示できるのに対して、***埋め込みシーケンス***&#x200B;では、コンテンツの一般的なスライドショーのみ表示できます。また、動的埋め込みシーケンスを設定する際は、チャネルの役割と名前を使用してチャネルを設定する必要があります。 実践的な実装については、次の手順を参照してください。
>
