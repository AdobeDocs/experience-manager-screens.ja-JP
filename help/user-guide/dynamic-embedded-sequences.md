...
1. **チャネルのそれぞれのロケーションにコンテンツを追加します。**
   ...
   次に移動： **デモ** > **場所** > **地域 A** > **地域 A** をクリックします。 **編集** をクリックします。 チャネルに追加するアセットをドラッグ＆ドロップします。
   ...
   同様に、 **デモ** > **場所** > **地域 B** > **地域 B** をクリックします。 **編集** 次に示すように、アクションバーからチャネルにアセットをドラッグ&amp;ドロップします。
...
1. **スケジュールにチャネルを割り当てます。**
   ...
   1. に移動します。 **デモ** > **スケジュール** > **AdSchedule** をクリックします。 **ダッシュボード** をクリックします。
...
表示パスを **デモ** > **場所** > **地域 A** > **ストア 1** > **Store1Display**&#x200B;に設定すると、次のコンテンツがAEM Screens Player に表示されます。

![channeldisplay1](assets/channeldisplay1.gif)

**シナリオ 1**：

表示パスを **デモ** > **場所** > **地域 B** > **ストア 3** > **Store3Display**&#x200B;に設定すると、次のコンテンツがAEM Screens Player に表示されます。
