...
1. **ロケーションの作成**
   ...
   1. を選択 **作成** アクションバーから、という名前の場所を作成します。 **ストア** ウィザードから変更します。

   ![screen_shot_2019-02-22at121638pm](assets/screen_shot_2019-02-22at121638pm.png)

1. **ロケーションにディスプレイを作成する**

   場所に移動（**ストア**）に設定し、 **作成** アクションバーから。 ウィザードの後に、次の 2 つを作成します **ディスプレイ** タイトルは **StoreFront** および **StoreRear**.
...
1. スケジュールに両方のディスプレイを割り当て優先度を設定する
   ...
   1. スケジュールを選択 **（ストアスケジュール）** を選択して、 **Dashboard** アクションバーから。

   1. を選択 **+ チャネルを割り当て** から **割り当てられたチャネル** パネル。
...
1. **各ディスプレイへのスケジュールの割り当て**
   ...
   1. を選択 **...** から **割り当てられたチャネルとスケジュール** パネルと、さらに次の項目を選択 **+スケジュールの割り当て**.
...
1. 「」を選択します **Emergen シーチャネル** から **StoreSchedule** ダッシュボードと選択 **割り当ての編集**.

   ![screen_shot_2019-02-25at101239pm](assets/screen_shot_2019-02-25at101239pm.png)

1. を更新 **優先度** の **Emergen シーチャネル** 対象： **3** から **チャネル割り当て** ダイアログボックスで「」を選択します。 **保存**.
