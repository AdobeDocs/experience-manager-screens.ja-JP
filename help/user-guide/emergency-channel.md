...
1. **シーケンスチャネルを作成する**
   ...
   1. 「」をクリックします **チャネル** フォルダーをクリックし、 **作成**.

   1. クリック **シーケンスチャネル** ウィザードから、という名前のチャネルを作成します。 **MainAdChannel**.

   ![screen_shot_2019-02-21at35932pm](assets/screen_shot_2019-02-21at35932pm.png)

1. **シーケンスチャネルにコンテンツを追加する**

   1. チャネル（**MainAdChannel**）に設定します。
...
1. **緊急チャネルを作成する**
   ...
   1. 「」をクリックします **チャネル** フォルダー。
   1. 「**作成**」をクリックします。
   1. クリック **シーケンスチャネル** ウィザードから、という名前のチャネルを作成します。 **Emergen シーチャネル**.
...
1. スケジュールに両方のディスプレイを割り当て優先度を設定する
   ...
   1. スケジュールをクリックします **（ストアスケジュール）** をクリックして、 **Dashboard** アクションバーから。

   1. **割り当てられたチャネル**&#x200B;パネルで「**+ チャネルを割り当て**」をクリックします。

   1. **チャネル割り当て**&#x200B;ダイアログボックスで、次の操作をおこないます。

      1. へのパスをクリックします **MainAdChannel**
      1. 「**優先度**」を「2」に設定します。
...
1. **各ディスプレイへのスケジュールの割り当て**
   ...
   1. スケジュールのパスをクリックします（ここでは、 **Emergen シーチャネル** > **スケジュール** >**StoreSchedule**）に設定します。
...
1. に移動します。 **Emergen シーチャネル** > **スケジュール** > **StoreSchedule** をクリックして、 **Dashboard** アクションバーから。

   ![screen_shot_2019-02-25at101112pm](assets/screen_shot_2019-02-25at101112pm.png)

1. 「」をクリックします **Emergen シーチャネル** から **StoreSchedule** ダッシュボードで、 **割り当ての編集**.
