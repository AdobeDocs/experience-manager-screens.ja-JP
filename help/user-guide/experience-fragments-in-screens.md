...
1. **エクスペリエンスフラグメントのライブコピーの作成**
   ...
   1. AEM ホームページに移動します。
   1. を選択 **エクスペリエンスフラグメント** を選択して、 **ScreensFragment** を選択して、 **バリエーションをライブコピーとして**&#x200B;を参照してください（下図を参照）。

   ![screen_shot_2019-07-29at110443am](assets/screen_shot_2019-07-29at110443am.png)

   c. 「」を選択します **ScreensFragment** から **ライブコピーを作成** ウィザードと選択 **次**.
   ...
   >[!NOTE]
   >
   >AEM Screens フラグメントを作成したら、フラグメントのプロパティを編集できます。 フラグメントを選択して、を選択します。 **プロパティ** アクションバーから。

   **Screens フラグメントのプロパティの編集**

   1. に移動します。 **ScreensFragment** （前の手順で作成したもの）を選択し、 **プロパティ** アクションバーから。
...
1. **Screens チャネルでのコンポーネントとしてのエクスペリエンスフラグメントの使用**
   ...
   1. 「」を選択します **TestChannel** を選択して、 **編集** アクションバーから。

   1. サイドタブから、コンポーネント アイコンを選択します。
...
1. からエクスペリエンスフラグメントを選択 **Sites** （プライマリ）ページに移動し、鉛筆アイコンを選択して、エクスペリエンスフラグメント内の項目を編集できるようにします。

   ![screen_shot_2018-06-08at122655pm](assets/screen_shot_2018-06-08at122655pm.png)

1. エクスペリエンスフラグメントを選択し、レンチ アイコンを選択すると、ダイアログボックスを開いて画像を編集できます。
...
1. エクスペリエンスフラグメントを選択し、ロールアウト アイコンを選択して、チャネルで使用されているフラグメントに変更を反映させます。
