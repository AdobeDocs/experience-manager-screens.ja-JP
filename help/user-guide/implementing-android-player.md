---
title: Android&trade; Playerの実装
description: Android&trade; Watchdogの導入について説明します。このソリューションでは、Android&trade; Playerをクラッシュから復旧できます。
...
*PowerManager*&#x200B;や&#x200B;*HDMIControlServices*&#x200B;など、Android™の特権APIの一部にアクセスするには、製造元のキーを使用してAndroid™`apk`に署名します。
...
クロス Android™ ウォッチドッグサービスは、*AlarmManager*&#x200B;を使用してCordova プラグインとして実装されます。
