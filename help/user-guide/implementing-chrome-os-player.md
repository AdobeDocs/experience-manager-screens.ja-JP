...
ユーザーにわかりやすいデバイス名を Chrome Player に割り当てて、割り当てられたデバイス名をAdobe Experience Manager（AEM）に送信することができます。 この機能により、Chrome プレーヤーに名前を付けるだけでなく、適切なコンテンツを簡単に割り当てることもできます。
...
1. Chrome ウェブストアでAEM Screens Player をクリックします。

   >[!NOTE]
   >
   >最近公開されたアプリがこのリストに表示されるまで、約 15 分かかります。

1. クリック **AEM Screens Player** から **自動起動キオスクアプリ** ドロップダウン。
...
1. Chrome Developer コンソールにログインします。
1. を参照 **デバイス管理** > **Chrome デバイス** 制御するデバイスをクリックします。
