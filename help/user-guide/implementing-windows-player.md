...
ログイントークン Cookie **の** SameSite属性を&#x200B;**Lax**&#x200B;から&#x200B;**None**&#x200B;に&#x200B;**Adobe Experience Manager Web コンソールから設定します
すべてのAEM オーサーインスタンスとパブリッシュインスタンスの設定**。

次の手順に従います。

1. **Adobe Experience Manager Web コンソールに移動します
`http://localhost:4502/system/console/configMgr`を使用した構成**。
