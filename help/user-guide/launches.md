...
1. チャネルを選択 **FutureLaunch** を選択して、 **ローンチを作成** アクションバーから。

   ![画像](/help/user-guide/assets/launches-images/launches-12.png)

1. **ローンチを作成**&#x200B;ウィザードが開きます。ウィザードに既に表示されているチャネルを選択するか、を選択します **+ チャネルを追加** ローンチを作成するチャネルを追加します。

1. を選択 **次** から **ローンチを作成** ウィザード。 「**サブページを含める**」オプションはデフォルトで選択されています。
   ...
   使用目的 **チャネルを追加** オプションで、ローンチを作成するチャネルに移動し、を選択します。 **を選択**.
...
1. 「**ローンチタイトル**」に「**SummerPromotions**」と入力します。「**ローンチ日**」を設定する必要はありません（下図を参照）。「**作成**」を選択します。
...
1. ローンチを選択し、 **ローンチのプロパティ** から **保留中のローンチ** パネル。
