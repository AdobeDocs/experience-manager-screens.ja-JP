...
AEM Screens 用のプロジェクトを作成したら、以下の手順に従ってプロジェクト用のチャネルを作成します。

1. Adobe Experience Manager リンク（左上）をクリックし、「Screens」をクリックします。 または、`https://localhost:4502/screens.html/content/screens` から直接アクセスすることもできます。

1. Screens プロジェクトに移動し、**チャネル**&#x200B;フォルダーをクリックします。
...
| シーケンスチャネル | コンポーネントを連続して（スライドショーで 1 つずつ）再生するチャネルを作成します。 |
| アプリケーションチャネル | Screens Player でカスタム web アプリケーションを表示します。 |
| 1 x 1 分割画面チャネル | 1 つのゾーンにコンポーネントを表示します。 |
| 1 x 2 分割画面チャネル | 2 つのゾーン（水平に分割）にアセットを表示します。 |
| 2 x 1 分割画面チャネル | 2 つのゾーン（垂直に分割）にアセットを表示します。 |
| 2 x 2 分割画面チャネル | 4 つのゾーン（マトリックス状に水平および垂直に分割）にアセットを表示します。 |
| 2～3 分割画面チャネル | 2 つのゾーン（水平に分割）にアセットを表示します。一方のゾーンが他方のものよりも大きくなります。 |
| 左または右 L バー型分割画面チャンネル | コンテンツ作成者は、様々な種類のアセットを適切なサイズのゾーンに表示できます。 |
...
>[!IMPORTANT]
>
>コンテンツを作成してチャネルに追加したら、次の手順では、ロケーションを作成してからディスプレイを作成します。 さらに、そのチャネルをディスプレイに割り当てます。 この節の最後に記載されているリソースを参照してください。
...
1. エディターで、アセットの下の「**ビデオ**」をクリックし、必要なビデオをドラッグ＆ドロップします。
...
（**...**）をクリックします **チャネル情報** アクションバーから、プロパティの表示、コンテンツの編集、チャネルのキャッシュ（オフラインコンテンツ）の更新を行うことができます。
...
1. **チャネルをオフラインに設定**
   1. チャネルをクリックし、アクションバーの「**プロパティ**」をクリックします。
...
1. **開発者****モード（チャネルを強制的にオンラインにする）**&#x200B;をオンにして、チャネルをオンラインにします。
...
**割り当てられたディスプレイ**&#x200B;パネルには、チャネルに関連するディスプレイが示されます。 割り当てられたディスプレイのスナップショットを解像度と共に表示します。
