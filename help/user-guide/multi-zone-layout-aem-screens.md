...
1. に移動します。 **チャネル** フォルダーと選択 **作成** アクションバーから。

1. **作成**&#x200B;ウィザードで「**1 x 2 分割画面チャネル**」を選択します。

1. を選択 **次** を入力し、 **タイトル** as **MultiZone**.

1. を選択 **作成** をクリックしてチャネルの作成を完了します。
...
1. **チャネルにコンテンツを追加する**
   ...
   1. 「」を選択します **MultiZone** チャネルと選択 **編集** アクションバーから。
...
1. **チャネルフォルダーの作成**
   ...
   1. に移動します。 **ゾーン** > **MultiZone** > **チャネル** を選択して、 **作成** アクションバーから。
   1. を選択 **チャネルフォルダー** から **作成** ウィザードと選択 **次**.
   1. タイトルに「」と入力 **EmbeddedChannels** を選択して、 **作成**.

   ![screen_shot_2018-12-19at125428pm](assets/screen_shot_2018-12-19at125428pm.png)

1. **チャネルフォルダーにさらに 2 つのチャネルを追加する**

   1. に移動します。 **ゾーン** > **チャネル** > **EmbeddedChannels** を選択して、 **作成** アクションバーから。
   1. を選択 **シーケンスチャネル** から **作成** という名前のチャネルの作成ウィザード **`Zone1`**.
   1. を選択 **`Zone1`** を選択して、 **編集** アクションバーから。
...
1. **メインチャネル（MultiZone）に埋め込みシーケンス（コンポーネント）を追加する**
   ...
   1. 「」を選択します **設定** （レンチ）アイコンを、エディターに埋め込まれたシーケンスの 1 つに追加します。
