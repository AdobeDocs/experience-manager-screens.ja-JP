...
1. **チャネルフォルダーの作成**
   ...
   1. に移動します。 **ゾーン** > **MultiZone** > **チャネル** をクリックします。 **作成** をクリックします。
...
1. **チャネルフォルダーにさらに 2 つのチャネルを追加する**
   ...
   1. に移動します。 **ゾーン** > **チャネル** > **EmbeddedChannels** をクリックします。 **作成** をクリックします。
...
1. **メインチャネル（MultiZone）に埋め込みシーケンス（コンポーネント）を追加する**
   ...
   1. チャネルパスとしてを選択します。 **ゾーン** > **チャネル** > **EmbeddedChannels** > **Zone1**（下の図を参照）。
