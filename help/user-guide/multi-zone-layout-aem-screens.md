---
title: マルチゾーンレイアウト
description: 複数のゾーンコンテンツを作成し、ビデオ、画像およびテキストなどの様々なアセットを使用して、AEM Screensで 1 つの画面に結合する方法を説明します。
contentOwner: jsyal
...
1. に移動します。 **チャネル** フォルダーをクリックし、 **作成** アクションバーから。
