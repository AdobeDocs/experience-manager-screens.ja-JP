...
* **ビデオのサムネールサポート**
  ...
  ビデオのサムネールが AEM Screens でサポートされるようになりました。コンテンツ作成者は、画像がプレースホルダーとして使用されるように、ビデオのサムネールを定義します。また、適切なチームが実際のビデオに関する最終決定を下す間に、コンテンツの再生とターゲティングのテストも適切に行います。その画像は、ビデオの再生に失敗した場合でも使用できます。
