...
1. 必要に応じて、TLS を設定します。 ポートに移動し、サーバーからポート番号を選択して、 **保存**.

1. に移動します。 **デバイス** タブをクリックして、設定したデバイスを確認します。 デバイスが見つかったら、チェックボックスをオンにし、 **承認**.

   >![画像](/help/user-guide/assets/tizen/rms-3.png)

1. 必要な情報を入力し、デバイスグループを選択します。「**OK**」を選択します。

   >![画像](/help/user-guide/assets/tizen/rms-7.png)

1. デバイスが承認されると、デバイスリストに表示されます。 を選択 *情報* 次に示すように、デバイスボックスに入力します。

   >![画像](/help/user-guide/assets/tizen/rms-6.png)

1. デバイス情報ダイアログボックスが表示されます。「」を選択します **デバイス情報** tab キーを押して選択 **編集**.

   >![画像](/help/user-guide/assets/tizen/rms-5.png)

1. デバイスのオプションを編集し、「**Setup**」タブを選択します。に移動します。 **URL ランチャー** セクションに移動し、ウィジェットをホストする URL を入力して、 `SSSP config file` 以下に、 `SSSP` アプリケーション（下図を参照）。
