...
1. から **デバイス** パネルで、プライマリとして設定するデバイスを選択します。 次の例は、Chrome デバイスをプライマリとして設定する方法を示しています。クリック **プライマリデバイスとして設定**.
...
から他のデバイス（この場合は Windows プレーヤー）を選択します。 **デバイス** パネルを開き、 **プライマリデバイスに同期**.
