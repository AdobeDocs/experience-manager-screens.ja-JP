...
次の図は、Mobile Network with Mobile Data RouterとActive Network Componentsの構成を示しています。Internet Accessには、独自の3/4/5Gデータリンクを使用したInternet Accessによる任意のAEM ScreensコントローラのInternet Accessが含まれています。
