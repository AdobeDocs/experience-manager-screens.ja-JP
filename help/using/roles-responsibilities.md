...
>[!NOTE]
>
>デジタルサイネージプロジェクト上の様々な役割と責務およびターゲットオーディエンスについて詳しくは、**[プロジェクト上の役割と責務](https://experienceleague.adobe.com/en/docs/experience-manager-screens/user-guide/digital-signage-network/project-roles-responsibilities)**&#x200B;を参照してください。
...
>
>プロジェクトのプリプロダクション、プロジェクトの開始、プロジェクトの進行については、次のビデオをご覧ください。 **[プロジェクトの管理とデプロイメント](https://experienceleague.adobe.com/en/docs/experience-manager-screens/user-guide/digital-signage-network/project-management-and-deployment)**.
...
| **フェーズ** | **オーディオ/ビデオインテグレーター** | **AEM 実装者** | **ビジネス戦略** | **コンテンツ管理** |
|---|---|---|---|---|
...
* **技術者**：オーディオ/ビデオインテグレーターから契約を結んでいるか、同じ会社の一員です。
