...
| *Day 1：プロジェクトの実装（アプリケーション設計）* |
| 役割と責務に関する合意 | RA | RA | RA | RA |
| プロジェクト計画およびスケジュールの調整 | RA | RA | C | C |
| 現在のサーバー環境の評価 | I | RA | I | I |
| UX デザインの要件 | I | AR | C | AR |
| 技術要件の検証 | I | RA | RA | C |
| アーキテクチャ設計 | I | AR | I | I |
| UI デザインに関するデータ構造の検証 | I | AR | C | C |
| アプリケーション開発 | RA | RA | RA | RA |
| AEM Screens プロジェクトの設定 | I | AR | C | I |
| Analytics の実装 | I | AR | C | - |
| テストと導入 | AR | C | AR | I |
| サーバー設定 | I | AR | I | I |
| コンテンツ更新計画 | I | AR | C | C |
| パイロットから実稼働への移行計画 | AR | AR | I | I |
| 知識移転 | AR | AR | I | I |
| *Day 1：プロジェクトの実装（小売への対応準備）* |
| ハードウェアの発注と保管 | AR | I | I | I |
| 小売オンボーディングスケジュール | I | I | C | AR |
| ユーザー受け入れテストのステージング | I | C | AR |  |
| ハードウェア一括設定 | AR | I | C | I |
| 運用開始後のサポートに関する合意 | AR | C | AR | C |
| *Day 1：プロジェクトの実装（ハードウェア）* |
| 役割と責務に関する合意 | RA | RA | RA | RA |
| 小売設計には配線作業が含まれる | - | - | - | - |
| プレイヤーハードウェアの選択 | RAC | - | - | - |
| マスターデバイス管理 | RA | I | - | - |
