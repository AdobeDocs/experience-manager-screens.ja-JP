...
次の表に、ゼロ日の概 **要を示します。プリセールスに関する考慮事項**:
...
次の表に、1日目の概 **要を示します。プロジェクトの実装（アプリケーション設計）**:
...
次の表に、1日目の概 **要を示します。プロジェクトの実装(Retail Readiness)**:
...
次の表に、1日目の概 **要を示します。1日目：プロジェクトの実装（ハードウェア）**:
